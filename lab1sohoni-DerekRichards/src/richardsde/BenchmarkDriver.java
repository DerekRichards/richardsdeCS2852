...
public class BenchmarkDriver {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ArrayList String removing from front: " +
                removeFromFrontBenchmark(stringArrayList, largeNItems) + " ms");
        System.out.println("LinkedList String removing from front: " +
                removeFromFrontBenchmark(stringLinkedList, largeNItems) + " ms");
        System.out.println();

        System.out.println("ArrayList String getting from middle: " +
                getMiddleBenchmark(stringArrayList, largeNItems) + " ms");
        System.out.println("LinkedList String getting from middle: " +
                getMiddleBenchmark(stringLinkedList, largeNItems) + " ms");
    }
}
